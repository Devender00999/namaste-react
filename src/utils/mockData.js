export const restarurantData = [
   ...
   },
   {
      info: {
         ...
         availability: {
            nextCloseTime: "2024-08-11 05:45:00",
            opened: true,
         },
         badges: {
            imageBadges: [
   ...
   },
   {
      info: {
         ...
         availability: {
            nextCloseTime: "2024-08-11 04:30:00",
            opened: true,
         },
         badges: {
            imageBadges: [
   ...
   },
   {
      info: {
         ...
         cuisines: ["Kerala", "Biryani", "Seafood", "Beverages", "Ice Cream", "Desserts"],
         avgRating: 4.4,
         parentId: "356891",
         avgRatingString: "4.4",
         totalRatingsString: "500+",
      ...
      analytics: {},
      cta: {
         link: "https://www.swiggy.com/restaurants/moplahs-5th-block-koramangala-bangalore-596862",
         type: "WEBLINK",
      },
   },
   {
